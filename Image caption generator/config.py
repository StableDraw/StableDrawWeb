...
config = {
	'images_path': 'R:/QuickDrowDataset/', #Make sure you put that last slash(/)
	'train_data_path': 'trainImages.txt', #Flickr_8k.trainImages.txt
	'val_data_path': 'valImages.txt', #Flickr_8k.devImages.txt
	'captions_path': 'prompt.txt', #Flickr8k.token.txt
