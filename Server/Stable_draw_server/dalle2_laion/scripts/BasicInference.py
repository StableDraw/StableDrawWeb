...
class BasicInference(InferenceScript):
    def run(
        ...
        if isinstance(text, str):
            text = [text]
        self.print(f"Генерация изображенитя для описания: {text}")
        self.print("Генерация первичных имбедингов...")
        ...
        self.print("Окончание генерации первичных имбедингов")
        ...
        self.print(f"Сгруппированы {len(text)} тексты в {len(image_embeddings)} имбединги.")
        self.print("Семплирование от декодера...")
        ...
        self.print("Окончание семплирования от декодера")
