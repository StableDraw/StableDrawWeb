...
using Cutter.Controllers;
using Cutter.Models;

namespace Cutter
{
    public class Cutterclass
    {
        // Data about image
        ...
        private static Cutterclass Operate(Bitmap im)
        {
            Cutterclass data = getcoordinates(im);
        ...
        private static Bitmap convert512(Bitmap img, Color c, Point p)
        {
            ...
            Bitmap res = new Bitmap(512, 512, PixelFormat.Format16bppRgb555);
        ...
        private static Cutterclass getcoordinates(Bitmap img)
        {
            Cutterclass result = new Cutterclass();
