"`local_fastai.core` contains essential util functions to format and split data"
...
def chunks(l:Collection, n:int)->abc.Iterable:
...
def listify(p:OptListOrItem=None, q:OptListOrItem=None):
    ...
    elif not isinstance(p, abc.Iterable): p = [p]
...
class ItemBase():
    "Base item type in the local_fastai library."
...
def download_url(url:str, dest:str, overwrite:bool=False, pbar:ProgressBar=None,
    ...
    with open(dest, 'wb') as f:
        ...
        try:
            ...
            fname = url.split('/')[-1]
            from local_fastai.datasets import Config
