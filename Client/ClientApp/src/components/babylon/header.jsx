...
export const Header = ({ setTheme, isLightTheme }) => {
	...
	return (
		<AppBar position="static" className={isLightTheme ? headerClassesLight.appBar : headerClasses.appBar} >
			<Toolbar className={isLightTheme ? headerClassesLight.appBar : headerClasses.appBar}>
