        ...
        <div className={cl.nav}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="59" height="44" viewBox="0 0 59 44" fill="none">
                    ...
                    <defs>
                        <linearGradient id="paint0_linear_8_37" x1="-0.000623482" y1="21.9993" x2="59.0014" y2="21.9993" gradientUnits="userSpaceOnUse">
                            ...
                            <stop offset="1" stopColor="#E5007E"/>
                        </linearGradient>
                    </defs>
                </svg>
            </NavLink>
            ...
            <label className={cl.el}>
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                    <path fillRule="evenodd" clipRule="evenodd" d="M16 15C15.4477 15 15 15.4477 15 16V47C15 47.5523 15.4477 48 16 48H47C47.5523 48 48 47.5523 48 47V16C48 15.4477 47.5523 15 47 15H16ZM43.2856 19.7143H19.7142V43.2857H43.2856V19.7143Z" fill="#656565"/>
                    <path d="M47 16L16 47" stroke="#CE3E3E" strokeWidth="2" strokeLinecap="round"/>
