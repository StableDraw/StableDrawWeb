...
let resMemo1 = ''
const TwoImagesVariant = ({setModal, props}) => {
    ...
    const imageGetter = useMemo(() =>
        ...
        >
            className={cl.imageBlock}>
            {sceneModal && <div className={cl.sceneModal}>
                <Typography className={cl.txt}>
                    {sceneModal}
                </Typography>
            </div>
            }
...
export default TwoImagesVariant;