    ...
    return (
        <div className = {cl.changsumBlock}>
            <div className = {cl.changsumBlockText}> 
                <Button className = {cl.sizeChangBtn} onClick={Minus} style={{maxWidth: '20%', minWidth: '20%'}} >-</Button>
                <div>{changsum}</div>
                <Button className = {cl.sizeChangBtn} onClick={Plus} style={{maxWidth: '20%', minWidth: '20%'}}>+</Button> 
            </div>
            <div>{5000} P</div>
        </div>
    );
