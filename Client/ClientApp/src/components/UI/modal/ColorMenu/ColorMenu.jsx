 ...
 */
    ...
    return (
        <div style={{width:50, display:'inline'}}>
            ...
            {/*<ToolButton src={'palette.png'} visible={modal} setVisible={setModal} title={'Выбор цвета'} isVisibleClass={cl.active} isInvisibleClass={cl.unactive}/>*/}
